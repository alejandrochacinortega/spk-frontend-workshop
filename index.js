...
const onlyBlueEyes = () => {
    console.log(`onlyBlueEyes: ADD LOGIC `)
}
...
const youngerThan30 = () => {
    console.log(`youngerThan30: ADD LOGIC `)
...
const olderThan30ContainsE = () => {
    console.log(`olderThan30ContainsE: ADD LOGIC `)
...
const howManyPeopleLikesStrawberry = () => {
    console.log(`howManyPeopleLikesStrawberry: ADD LOGIC `)
...
const getPersonById = () => {
    console.log(`getPersonById: ADD LOGIC `)
}
